...
public class SauceMakingMachineBlock extends BlockWithEntity {
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    public SauceMakingMachineBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (blockEntity instanceof SauceMakingMachineBlockEntity entity) {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new SauceMakingMachineBlockEntity(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, EntityTypesRegistry.SAUCE_MAKING_MACHINE_BLOCK_ENTITY, SauceMakingMachineBlockEntity::tick);
    }
}
